    ...
    <main>
      <Section class="flex-center section-bg" id="about">
        ...
        <p class="text-center">
          ...
          <wbr />
          who started programming in 2018-2019.<br />I don't really remember.<br /><br />Started
          with
          <wbr />
          <a href="https://minecraft.net" class="link-underline" target="_blank"
            >⛏️minecraft</a
          >
          redstone and command blocks.<br />Then I learned python from
          <wbr />
          various youtube tutorials &amp; various online courses.<br /><br />Since
          then,
          <wbr />
          I've come a long way and have done a wide variety of projects<br /><br /><small
            >Hopefully I'll finish the mountain of side projects someday...
      ...
      <Section class="flex-center section-bg" id="skills">
        ...
        <div id="skills-section-layout">
          <div id="skills-txt">
            <h1>What I know 📖</h1>
            <p>
              These are some of the&nbsp;<wbr /> 🛠️<b>skills</b>,&nbsp;<wbr />
              📜<b>languages</b>&nbsp;&amp;&nbsp;<wbr />
              🪜<b>frameworks</b>,<br />
              <wbr />
